...
class ProductionFAISSIndex:
    ...
    def search(self, query_vector: np.ndarray, k: int = 5) -> Tuple[List[float], List[int], List[str]]:
        ...
        with self._lock:
            ...
            index_dim = self.index.d if hasattr(self.index, 'd') else Constants.VECTOR_DIM
    ...
    # ==================== NEW METHOD: FIND SIMILAR INCIDENTS ====================
    ...
    def get_index_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            try:
                ...
                dimension = self.index.d if hasattr(self.index, 'd') else Constants.VECTOR_DIM
    ...
    # ==================== NEW METHOD: FIND SIMILAR BY METRICS ====================
